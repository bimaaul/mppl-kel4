    ...
    <div className={classes.root}>
      <div className={classes.add__testi}>
        ...
        <div className={classes.add__button} align="center">
          ...
          <p className={classes.p} align="center">Add New Project</p>
        </div>
          ...
          <Table className={classes.table} aria-label="list__project__table">
            <TableHead>
              <TableRow>
                ...
                <TableCell style={{ color: 'white' }} align="left">Judul</TableCell>
                <TableCell style={{ color: 'white' }} align="left">Durasi Pengerjaan</TableCell>
            ...
            <TableBody>
              {rows.map((row) => (
                <TableRow key={row.no}>
                  ...
                  <TableCell className={classes.cell} align="left">{row.judul}</TableCell>
                  <TableCell className={classes.cell} align="left">{row.durasi_pengerjaan}</TableCell>
